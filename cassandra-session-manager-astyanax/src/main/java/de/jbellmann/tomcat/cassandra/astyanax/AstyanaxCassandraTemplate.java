...
public class AstyanaxCassandraTemplate extends CassandraTemplate {
    ...
    private de.jbellmann.tomcat.cassandra.astyanax.ObjectSerializer objectSerializer;

    @Override
    public void initialize(ClassLoader classLoader) {
        
        objectSerializer = new de.jbellmann.tomcat.cassandra.astyanax.ObjectSerializer(classLoader);
