 ...
 *
 */
public abstract class CassandraTemplate implements CassandraOperations {
    ...
    protected static final List<String> SPECIAL_ATTRIBUTES = new ArrayList<String>();
    ...
    public abstract void initialize(ClassLoader classLoader);
